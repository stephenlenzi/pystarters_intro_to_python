...
"""what happens if you try to add two different types? dealing with many things (lists, tuples)
"""
...
my_set_of_randomly_organised_stuff = set(my_randomly_organised_stuff)
...
for x in my_number_list:
    print(number)   # maybe this does not work as expected. why?


"""getting the loop iteration out (maybe do this with a dictionary instead)
    >>> for i, number in enumerate(my_number_list):
    >>>     print(i, number)"""
...
"""- Conditional statements
    ...
    if > ,
    sum until exit value is reached?
    if ==, return total"""
